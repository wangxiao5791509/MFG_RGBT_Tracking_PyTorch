...
class RegionDataset(data.Dataset):
    def __init__(self, img_dir, img_list_v, img_list_i, videoPath_v, videoPath_i, gt, receptive_field, opts):
        
        # self.img_list_v = np.array([os.path.join(img_dir, img) for img in img_list_v])
        # self.img_list_i = np.array([os.path.join(img_dir, img) for img in img_list_i])

        self.img_list_v = np.array([img_dir+ '/v/' +img for img in img_list_v])
        self.img_list_i = np.array([img_dir+ '/i/' +img for img in img_list_i])

        self.videoPath_v = videoPath_v 
        self.videoPath_i = videoPath_i 
