...
if __name__ == "__main__":
    ...
    parser.add_argument("-set_type", default = 'dataset210')
    ...
    ## path initialization
    dataset_path = '/disc2/naipeng.ye/wangxiao/acm_mm2020_experiments/'
    result_home = '/disc2/naipeng.ye/wangxiao/acm_mm2020_experiments/daTANet-cbam-dfg-rgbt-RTMDNet-master-train-on-50/trackingResults_rgbt210/'
    ...
    for num, seq in enumerate(seq_list):
        ...
        if seq+"_rgbt210-daTANet-cbam-dfg-v1.txt" in already_done: 
            print("==>> Skip this video: ", seq) 
        else: 
            txtName = seq + '_rgbt210-daTANet-cbam-dfg-v1.txt'
